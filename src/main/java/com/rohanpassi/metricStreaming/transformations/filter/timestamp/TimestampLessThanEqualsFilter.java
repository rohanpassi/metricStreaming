...
@AllArgsConstructor
public class TimestampLessThanEqualsFilter implements MetricFilter {
    private final Instant timestamp;

    @Override
    public boolean apply(Metric metric) {
        return metric.getTimestamp().isBefore(timestamp) || metric.getTimestamp().equals(timestamp);
    }

    public TimestampLessThanEqualsFilter(TimestampFilterConfig config) {
